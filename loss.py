...
from utils import f1_score,get_answer
...
def loss_function_for_reinforcement(start_logits,end_logits,answer,document):
        ...
        rewards=reward(document,sample_start,sample_end,greedy_start,greedy_end,answer['start_offset'],answer['end_offset'])
        ...
        return reinforcement_loss+(expected_reward-reinforcement_loss.item())
...
def get_loss(start_logits,end_logits,answer,document,sigma_ce,sigma_rl):
        ...
        rl_loss=loss_function_for_reinforcement(start_logits,end_logits,document)
